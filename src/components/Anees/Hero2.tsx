...
/>
      ...
      <div className="absolute bottom-0 left-0 w-2/3 h-2/3 bg-gradient-to-tr from-[#26214D] via-[#26214D]/10 to-transparent rounded-full blur-[100px] opacity-40" /> */}
            <div className="md:w-2/3" data-aos="fade-down">
              <h2 className="text-black capitalize font-bold text-2xl lg:text-3xl mb-3 md:mb-5 z-50">
                Exclusivity. Uniqueness. Innovation.
              </h2>
              <h1 className="text-[1.7rem] md:text-[53px]  !font-extrabold  bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text d flex flex-col -space-y-5  z-50">
                <span className=""> TRANSFORM YOUR VISION
                     </span>
                  <span>
                     
                      INTO DIGITAL REALITY
                    </span> 
                <span className="text-[35px] !text-black pt-3 md:w-full ">YOUR SUCCESS IS OUR MISSION!
                    </span>
                   
              </h1>
              <p className="max-w-[320px] md:max-w-2xl text-base md:text-lg mt-3 md:mt-5 text-black z-50">
