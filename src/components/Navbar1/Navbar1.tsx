  ...
  return (
    <div
      className={cn(
        ...
        isScrolled
          ? "fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm shadow-lg z-50 animate-in slide-in-from-top-5 duration-300"
          : "relative",
      )}
    >
      {/* Main Navigation */}
      <div className="border-b relative overflow-hidden">
        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-4">
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 transition-all duration-500 hover:scale-105 relative z-10">
            <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
              <Image src="/assets/images/tech-craft-logo.png" alt="TechCraft Logo" width={250} height={370} />
            </motion.div>
          </Link>
          ...
          <div className="hidden lg:flex items-center justify-center flex-grow">
            <div className="flex items-center space-x-8">
              ...
              <div ref={menuRef} className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                <motion.button
                  className="group flex items-center space-x-1 text-base font-medium hover:text-[#7E43C7] transition-all duration-300 relative"
                  whileHover={{ y: -2 }}
                >
                  <span className="transform transition-all duration-300 group-hover:translate-y-[-2px]">Services</span>
                  ...
                  />
                  <div className="absolute bottom-[-29px] -left-1 w-full h-[5px] bg-gradient-to-r from-[#802FCE] to-[#5114AE] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-right rounded-t-md" />
                </motion.button>
              </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            <motion.div
              className="flex items-center cursor-pointer space-x-2 p-2 px-3 bg-gradient-to-r from-[#5114AE] to-[#802FCE] text-white rounded-full relative overflow-visible"
              whileHover={{ scale: 1.05, boxShadow: "0px 0px 15px rgba(126, 67, 199, 0.6)" }}
            ...
            <motion.div
              className="flex items-center space-x-2 text-[#5114AE] transition-all duration-300"
              whileHover={{ y: -2 }}
            >
              <motion.div
                animate={{ y: [0, -5, 0] }}
              ...
              <Link href="tel:+18583650790" className="font-semibold relative group">
                (667) 423-5532
                <span className="absolute bottom-1 left-0 w-full h-[1px] bg-[#5114AE] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
              </Link>
            </motion.div>
          </div>
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive ? "text-[#7E43C7]" : "hover:text-[#7E43C7]",
      )}
    >
      <motion.span
      ...
      <motion.div
        className={cn(
          "absolute -top-7 left-0 w-full h-[5px] bg-gradient-to-r from-[#5114AE] to-[#802FCE] transform transition-all duration-500 origin-left rounded-b-md",
      ...
      <motion.div
        className={cn(
          "absolute bottom-[-29px] left-0 w-full h-[5px] bg-gradient-to-r from-[#802FCE] to-[#5114AE] transform transition-all duration-500 origin-right rounded-t-md",
          isActive ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100",
        )}
        whileHover={{ boxShadow: "0 -2px 15px rgba(126, 67, 199, 0.8)" }}
      />
