    ...
    <div className="min-h-screen bg-[#FAFAFA] py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          ...
          >
            We have received your submission and will get back to you within 24 hours.
          </motion.p>
          ...
          >
            ...
            <ul className="text-left space-y-4 text-[#9A4770]">
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-[#332D67] bg-[#9A4770] hover:bg-[#9A4770] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200"
            >
              Return Home
            </Link>
          </motion.div>
