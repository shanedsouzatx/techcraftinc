...
export default function AllHero() {
  ...
  return (
    <div>
      <Hero
        title="SEM That Drives Results"
        subtitle="Targeted, data-driven ad campaigns designed to increase visibility, drive high-quality traffic, and maximize conversions."
