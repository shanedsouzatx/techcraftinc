...
<div className="relative  container flex flex-col md:flex-row items-center justify-between px-5 md:px-0 gap-36 ">
      ...
      >
        <h1 className={cn("text-2xl !font-bold pb-2 bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text  sm:text-3xl md:text-5xl lg:text-6xl ")}>
          {title}
        </h1>
        {subtitle && (
      ...
      >
        <Image 
          src={'https://res.cloudinary.com/dhggagqst/image/upload/v1742933653/Vector-06_vh2myl.png'} 
          alt="Hero Image" 
          width={500} 
          height={300} 
          className="-mr-52 "
