...
export default function AllHero() {
  ...
  return (
    <div>
      <Hero
        title="Email Marketing That Engages & Converts"
        subtitle="Personalized, data-driven email campaigns designed to nurture leads, boost engagement, and maximize conversions."
