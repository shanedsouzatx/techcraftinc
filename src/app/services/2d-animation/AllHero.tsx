...
export default function AllHero() {
  ...
  return (
    <div>
      <Hero
    title="2D Animation That Brings Stories to Life"
    subtitle="High-quality, visually engaging 2D animations designed to entertain, inform, and captivate your audience."
