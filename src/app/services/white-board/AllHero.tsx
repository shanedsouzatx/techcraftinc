...
export default function AllHero() {
  ...
  return (
    <div>
      <Hero
        title="Whiteboard Animation That Educates & Engages"
        subtitle="Captivating hand-drawn animations that simplify complex ideas, making learning engaging and memorable."
