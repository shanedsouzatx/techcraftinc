  ...
  const industries = [
    {
      ...
      description: "Crafting unique, memorable logos that reflect your brand’s identity and leave a lasting impression.",
    },
    {
      icon: "✏️",
    ...
    },
    {
      ...
      description: "Choosing the right color palette and typography to enhance your logo’s impact and brand recognition.",
    },
    {
      icon: "🚀",
