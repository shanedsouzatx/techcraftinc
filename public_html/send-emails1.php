...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Email configuration
    $to = "contact@techcraftinc.com"; // Change to your actual email
    $subject = "New Contact Form Submission";
    
    // Set sender email
    $senderEmail = isset($formData['email']) ? $formData['email'] : "noreply@techcraftinc.com";
    ...
    try {
        ...
        $mail->SMTPDebug = 2;  // Set to 2 to get detailed debugging info (set to 0 when done)
